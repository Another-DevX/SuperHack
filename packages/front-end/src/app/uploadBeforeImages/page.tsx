...
export default function uploadBeforeImages() {
  return (
    <div className="flex flex-col gap-4">
      <div className="flex items-start gap-4 p-4 bg-white rounded-lg">
        ...
        <p className="text-xs text-textSoftGray">
          Upload before images of the location where the transformation will be
          taking place. You will be asked to upload after images when the
